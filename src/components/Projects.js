...
import sbtracker from "../assets/sbtracker.png"
...
const Projects = () => {
  ...
  const projects =[
    ...
    },
    {
      id: 3,
      image: sbtracker,
      title: "Where is my School Bus",
      description: "Live bus tracking system for schools to address the challenges faced by working parents and educational institutions.",
      demolink: "https://github.com/AjmiNasar/gp18.sbtracker",
      githublink: "https://github.com/AjmiNasar/gp18.sbtracker"
    },
    {
      id: 4,
      image: ipl,
    ...
    },
    {
      ...
      image: decentra,
      title: "DecentraLaw",
      description: "A dApp that decentralizes the procedure of acquiring BAR Council licenses.",
  ...
  return (
    <>
      <h1 className='font-bold text-4xl md:text-5xl py-3 dm mx-auto text-rose-900 text-center mb-10 '>Projects</h1>
    <div className='w-full py-[5rem] bg-white overflow-x-scroll scrollbar-hide '>
